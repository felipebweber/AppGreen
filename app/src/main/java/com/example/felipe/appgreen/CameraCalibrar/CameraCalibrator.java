...
public class CameraCalibrator {
    ...
    private String nomeDiretorio = "Calibra";
    ...
    public void calibrate() {
        ...
        File fileExt = new File(diretorioApp, "Dados.txt");
    ...
    private void renderFrame(Mat rgbaFrame) {
        ...
        Core.putText(rgbaFrame, "Captured: " + mCornersBuffer.size(), new Point(rgbaFrame.cols() / 3 * 2, rgbaFrame.rows() * 0.2),
